...
import { getBlogPostBySlug, getAdjacentBlogPosts } from "@/lib/content";
  ...
  return (
    <div>
      ...
      <aside className="border-t pt-10 space-y-6">
        ...
        <div className="mt-4">
          <Link href="/blog" className="text-sm font-medium hover:underline text-muted-foreground hover:text-foreground">
