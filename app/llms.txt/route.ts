...
import { getAllPosts, getAllSeries, getAllBooks } from "@/lib/content";
...
- **Estrutura:** Reflexões bíblicas publicadas diariamente, organizadas em séries temáticas e por referência bíblica (livro, capítulo e versículo).
