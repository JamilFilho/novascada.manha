...
// ----------------------------------------------------------------
// Funções Auxiliares para Edições (Artigos)
// ----------------------------------------------------------------
...
export async function getAdjacentPosts(currentSlug: string) {
  ...
  // No array ordenado do mais recente [0] ao mais antigo [n]:
  // O post mais recente (Próximo) está no índice anterior (-1)
  const nextPost = currentIndex > 0 ? allPosts[currentIndex - 1] : null;
  
  // O post mais antigo (Anterior) está no próximo índice (+1)
